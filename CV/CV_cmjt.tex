...
%\textbf{Online:} \faGithub \hspace{1pt} @cmjt \hspace{1pt} @statbiscuit\hspace{4pt} \faCloud \hspace{1pt} @statbiscuit \hspace{4pt} \faDesktop \hspace{1pt} \httplink{cmjt.github.io}
...
Jones-Todd C, van Helsdingen A (2022). \texttt{stelfi}: Hawkes and Log-Gaussian Cox Point Processes Using Template Model Builder. \texttt{R} package version 1.0.0, \url{https://github.com/cmjt/stelfi/}.\\
...
\begin{itemize}
  ...
  \item Coordinator of the Ihaka Data Vizualisation competition 2023
...
\item Department of Statistics, University of Auckland
  ...
  \item \textit{Chair of the Christmas function organising committee, 2020, 2022, \& 2023}
