...
\texttt{stelfi}. Package to fit spatiotemporal point process models using \texttt{TMB}, \url{https://github.com/cmjt/stelfi}.\\
...
\item PhD
  \begin{itemize}
  \item Sophie Jones, \textit{Investigating the State of Statistical \& Data Literacy in Higher Education}, 2021--ongoing.
  \end{itemize}
\end{itemize}
