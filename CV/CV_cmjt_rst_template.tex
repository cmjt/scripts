...
\def\webpage		{https://cmjt.github.io/}		% personal website (if applicable)
...
\hline
\begin{itemize}
\item[] Semadeni-Davies, A., \textbf{Jones-Todd, C. M.},  Elliott, S., Shankar, U., Tanner, C., Srinivasan, MS., \& Muirhead , R. {\bf(In press)} CLUES model calibration: residual analysis to investigate potential sources of model error. New Zealand Journal of Agricultural Research.
\item[$\Asterisk$] Semadeni-Davies, A., {\bf Jones-Todd, C. M.},  Elliott, S., Shankar, U., Tanner, C., Srinivasan, MS., \& Muirhead , R. (2019) CLUES model calibration and its implications for estimating contaminant attenuation. Agricultural Water Management, 105853.
