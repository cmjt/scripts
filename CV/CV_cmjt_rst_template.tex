...
%----------------------------------------------------------------------------
    \noindent
    2023--present, Senior Lecturer in Statistics, University of Auckland\\
    2019--2023, Lecturer in Statistics, University of Auckland\\
...
%----------------------------------------------------------------------------
    \noindent
    {\bf 2022}, Marsden Fund Fast-Start Grant recipient, Royal Society of New Zealand\\
    {\bf 2021}, New Zealand Statistical Association, Worsley Early Career Award\\
...
\hline
\begin{itemize}
  \item[$\Asterisk$] Hin, V., de Roos, A. M., Benoit-Bird, K. J., Claridge, D. E.,
DiMarzio, N.,  Durban, J. W., Falcone, E. A., Jacobson, E. A., { \bf Jones-Todd, C. M.}, Pirotta, E., Schorr G.S., Thomas, L., Watwood, S., \& Harwood, J. {\bf (In press)} Using individual-based bioenergetic models to predict the aggregate effects of disturbance on populations: a case study with beaked whales and Navy sonar. PLOS One.
    \item[] \textbf{Jones-Todd, C. M.}, Pirotta, E., Durban, J., Claridge, D., Baird, R., Falcone, E., Schorr, G., Watwood,S., \& Thomas, L.  \textbf{(2022)} Continuous-time discrete-space models of marine mammal exposure to Navy sonar. Ecological Applications, 32 (1): e02475.
...
% e.g. proceedings \\
\begin{itemize}
   \item \textbf{Jones-Todd, C. M.}, \& Renelle, A. {\bf (2022)}. Virtual experiments to teach experimental design: A web-based tool for biostatistics students bridging the gap between data collection and statistical analysis. In S. Peters (Ed.), Proceedings of the 11th International Conference on Teaching Statistics. 
...
\hline
\begin{itemize}
  \item Hatami, R., Lane, S., Robinson, A.,  Inglis, G.,  {\bf Jones-Todd, C. M.}, \& Seaward, K. Improving New Zealand’s marine biosecurity surveillance programme. A statistical review of biosecurity vectors.  Ministry for Primary Industries website. {\bf 2021}.
  \item Python, A., Illian, J. B., {\bf Jones-Todd, C. M.}, \& Bl\'angiardo, M. Statistics and Terrorism: Insights on terrorism lethality from Bayesian modeling. Wiley StatsRef-Statistics Reference Online.  {\bf 2020}
